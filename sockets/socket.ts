...
export const desconectar = ( cliente: Socket ) =>
{
    ...
    cliente.on('disconnect', () =>
    {
        ...
        // Mandamos llamar al método "borrarUsuario" que está dentro del archivo "usuarios-lista.ts"
        // "cliente.id" = Es el ID que el socket le asigna al cliente, recordamos que es un ID único, irrepetible
...
export const capturaEventos = ( cliente: Socket, io: socketIO.Server) =>
{
    ...
    cliente.on( 'configurar-usuario', ( payload: { nombre: string }, callback: Function ) =>
    {
        ...
        // "actualizarNombre"   = Método para actualizar el nombre del usuario, lo definimos en el archivo "usuarios-lista.ts"
